...
from awslabs.amazon_bedrock_agentcore_code_interpreter_mcp_server.tools import execution
from awslabs.amazon_bedrock_agentcore_code_interpreter_mcp_server.tools.execution import (
...
MODULE_PATH = 'awslabs.amazon_bedrock_agentcore_code_interpreter_mcp_server.tools.execution'
