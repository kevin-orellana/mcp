...
from awslabs.amazon_bedrock_agentcore_browser_mcp_server.tools.navigation import NAVIGATION_TIMEOUT_MS
    ...
    async def browser_close(
        ...
        try:
            ...
            if browser and browser.contexts and browser.contexts[0].pages:
                self._connection_manager.set_active_page(
                    session_id, browser.contexts[0].pages[-1]
                )
