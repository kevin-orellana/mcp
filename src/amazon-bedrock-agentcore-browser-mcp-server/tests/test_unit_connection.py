...
# Patch paths
PATCH_PW = (
    'awslabs.amazon_bedrock_agentcore_browser_mcp_server.browser.connection_manager.async_playwright'
)
PATCH_CLIENT = (
    'awslabs.amazon_bedrock_agentcore_browser_mcp_server.browser.connection_manager.get_browser_client'
)
...
class TestConnect:
    ...
    async def test_connect_passes_region(
        ...
        await connection_manager.connect(
            'sess-1', 'aws.browser.v1', region='eu-west-1'
        )
